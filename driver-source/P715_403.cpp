...
std::string ImpresorFiscalP715_403::Version ("SMH/P-715F - Versión 04.03");
...
// Constructor
//
ImpresorFiscalP715_403::ImpresorFiscalP715_403 ()
{
...
//
std::string
ImpresorFiscalP715_403::DescripcionModelo () const
{
	return 	(Version);
}
...
//
void
ImpresorFiscalP715_403::EstablecerModalidadResumenIVA (TiposDeResumenIVA Modo)
{
...
//
void
ImpresorFiscalP715_403::ObtenerDatosMemoriaDeTrabajo (RTA_ObtenerDatosMemoriaDeTrabajo *R) throw (Excepcion)
{
	// printf ("Comando ObtenerDatosMemoriaDeTrabajo ejecutado en P715_403\n");
...
//
void
ImpresorFiscalP715_403::CambiarFechaInicioActividades (const FECHA &Fecha) throw(Excepcion)
{
	// printf ("Comando CambiarFechaInicioActividades ejecutado en P715_403\n");
...
//
void
ImpresorFiscalP715_403::DatosCliente (
...
{
	// printf ("Comando DatosCliente ejecutado en P715_403\n");
...
//
void
ImpresorFiscalP715_403::BorrarFantasiaEncabezadoCola (bool BorrarFantasia, bool BorrarEncabezado, bool BorrarCola) throw (Excepcion)
{
	// printf ("Comando BorrarFantasiaEncabezadoCola ejecutado en P715_403\n");
...
//
void
ImpresorFiscalP715_403::BorrarInformacionRemitoComprobanteOriginal () throw (Excepcion)
{
	// printf ("Comando BorrarInformacionRemitoComprobanteOriginal ejecutado en P715_403\n");
...
//
void
ImpresorFiscalP715_403::ObtenerConfiguracion (RTA_ObtenerConfiguracion *R) throw (Excepcion)
{
	// printf ("Comando ObtenerConfiguracion ejecutado en P715_403\n");
...
//
void
ImpresorFiscalP715_403::ReporteZ (RTA_ReporteZX *R) throw (Excepcion)
{
	// printf ("Comando ReporteZ ejecutado en P715_403\n");
...
//
void
ImpresorFiscalP715_403::ReporteX (RTA_ReporteZX *R) throw (Excepcion)
{
	// printf ("Comando ReporteX ejecutado en P715_403\n");
...
//
double
ImpresorFiscalP715_403::ImprimirPago (
						const std::string &Texto,
						double Monto,
						const std::string &DescripcionAdicional) throw (Excepcion)
{
	// printf ("Comando ImprimirPago ejecutado en P715_403\n");
...
//
double
ImpresorFiscalP715_403::DevolverPago (
						const std::string &Texto,
						double Monto,
						const std::string &DescripcionAdicional) throw (Excepcion)
{
	// printf ("Comando DevolverPago ejecutado en P715_403\n");
...
//
void
ImpresorFiscalP715_403::DetalleRecibo (const std::string &Texto) throw (Excepcion)
{
	// printf ("Comando DetalleRecibo ejecutado en P715_403\n");
...
//
void
ImpresorFiscalP715_403::ImprimirInfoEnDNFH (const unsigned IDCampo,
											const std::string &Texto,
											double Cantidad) throw (Excepcion)
{
	// printf ("Comando ImprimirInfoEnDNFH ejecutado en P715_403\n");
