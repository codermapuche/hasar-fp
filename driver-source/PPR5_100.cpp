...
std::string ImpresorFiscalPPR5_100::Version ("SMH/P-PR5F - Versión 1.00");
...
//
void
ImpresorFiscalPPR5_100::AbrirDNFH (DocumentosNoFiscalesHomologados Tipo, const std::string &Nro) throw (Excepcion)
{
	// printf ("Comando AbrirDNFH ejecutado en PPR5_100\n");
