...
std::string ImpresorFiscalP715_504::Version ("SMH/P-715F - Versión 05.04");
...
// Constructor
//
ImpresorFiscalP715_504::ImpresorFiscalP715_504 ()
{
...
//
std::string
ImpresorFiscalP715_504::DescripcionModelo () const
{
	return 	(Version);
}
...
//
void
ImpresorFiscalP715_504::EstablecerModalidadResumenIVA (TiposDeResumenIVA Modo)
{
...
//
void
ImpresorFiscalP715_504::ObtenerDatosMemoriaDeTrabajo (RTA_ObtenerDatosMemoriaDeTrabajo *R) throw (Excepcion)
{
	// printf ("Comando ObtenerDatosMemoriaDeTrabajo ejecutado en P715_504\n");
...
//
void
ImpresorFiscalP715_504::CambiarFechaInicioActividades (const FECHA &Fecha) throw(Excepcion)
{
	// printf ("Comando CambiarFechaInicioActividades ejecutado en P715_504\n");
...
//
void
ImpresorFiscalP715_504::DatosCliente (
...
{
	// printf ("Comando DatosCliente ejecutado en P715_504\n");
...
//
void
ImpresorFiscalP715_504::BorrarFantasiaEncabezadoCola (bool BorrarFantasia, bool BorrarEncabezado, bool BorrarCola) throw (Excepcion)
{
	// printf ("Comando BorrarFantasiaEncabezadoCola ejecutado en P715_504\n");
...
//
void
ImpresorFiscalP715_504::BorrarInformacionRemitoComprobanteOriginal () throw (Excepcion)
{
	// printf ("Comando BorrarInformacionRemitoComprobanteOriginal ejecutado en P715_504\n");
...
//
void
ImpresorFiscalP715_504::ObtenerConfiguracion (RTA_ObtenerConfiguracion *R) throw (Excepcion)
{
	// printf ("Comando ObtenerConfiguracion ejecutado en P715_504\n");
...
//
void
ImpresorFiscalP715_504::ReporteZ (RTA_ReporteZX *R) throw (Excepcion)
{
	// printf ("Comando ReporteZ ejecutado en P715_504\n");
...
//
void
ImpresorFiscalP715_504::ReporteX (RTA_ReporteZX *R) throw (Excepcion)
{
	// printf ("Comando ReporteX ejecutado en P715_504\n");
...
//
double
ImpresorFiscalP715_504::ImprimirPago (
						const std::string &Texto,
						double Monto,
						const std::string &DescripcionAdicional) throw (Excepcion)
{
	// printf ("Comando ImprimirPago ejecutado en P715_504\n");
...
//
double
ImpresorFiscalP715_504::DevolverPago (
						const std::string &Texto,
						double Monto,
						const std::string &DescripcionAdicional) throw (Excepcion)
{
	// printf ("Comando DevolverPago ejecutado en P715_504\n");
...
//
void
ImpresorFiscalP715_504::DetalleRecibo (const std::string &Texto) throw (Excepcion)
{
	// printf ("Comando DetalleRecibo ejecutado en P715_504\n");
...
//
void
ImpresorFiscalP715_504::ImprimirInfoEnDNFH (const unsigned IDCampo,
											const std::string &Texto,
											double Cantidad) throw (Excepcion)
{
	// printf ("Comando ImprimirInfoEnDNFH ejecutado en P715_504\n");
...
//
void
ImpresorFiscalP715_504::ImprimirVoucher (const std::string &NombreCliente,
...
{
	// printf ("Comando ImprimirVoucher ejecutado en P715_504\n");
